...
#ifndef HVNFCREADERSDK_SWIFT_H
#define HVNFCREADERSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="HVNFCReaderSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC14HVNFCReaderSDK13BundleLocator")
...
SWIFT_CLASS("_TtC14HVNFCReaderSDK10HVNFConfig")
@interface HVNFConfig : NSObject
- (void)setQRDataWithQrData:(NSString * _Nonnull)qrData;
- (void)setIdNumberWithIdNumber:(NSString * _Nonnull)idNumber;
- (void)setdobWithDob:(NSString * _Nonnull)dob;
- (void)setdoeWithDoe:(NSString * _Nonnull)doe;
- (void)setDocumentTypeWithDocumentType:(enum DocumentType)documentType;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

typedef SWIFT_ENUM(NSInteger, DocumentType, open) {
  DocumentTypeVN_CHIP_ID = 0,
  DocumentTypeE_PASSPORT = 1,
};

@class UIViewController;

SWIFT_CLASS("_TtC14HVNFCReaderSDK8HyperNFC")
@interface HyperNFC : NSObject
+ (void)start:(UIViewController * _Nonnull)callingVC hvNFCConfig:(HVNFConfig * _Nonnull)hvNFCConfig :(void (^ _Nonnull)(HVNFCResult * _Nonnull))completionHandler;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC14HVNFCReaderSDK14PassportReader") SWIFT_AVAILABILITY(ios,introduced=13)
